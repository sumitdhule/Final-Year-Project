...
fname=req.getvalue("fnm")
lname=req.getvalue("lnm")
year=req.getvalue("yr")
Dept=req.getvalue("dept")
roll_number=req.getvalue("rno")
section=req.getvalue("sec")
image=req.getvalue("fileToUpload")
add_new_student(roll_number,section,Dept,fname,lname,year,image)
'''
